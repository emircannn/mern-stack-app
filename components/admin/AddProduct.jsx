  ...
  return (
    <div className='fixed overflow-y-auto overflow-x-hidden top-0 left-0 flex bg-black/75 w-screen h-screen items-center justify-center'>
        <OutsideClickHandler onOutsideClick={()=> setAddProduct(false)} >
            ...
            <h3 className='font-dancing text-white text-[40px] text-center font-bold'>Ürün Oluştur</h3>
            ...
            <div className='flex flex-col text-sm text-white my-2'>
                        ...
                        <div className='flex flex-col text-sm text-white mt-2'>
                            ...
                            p-2 outline-none text-secondary mt-1' type="text" placeholder='Bir Ürün Adı Yazın...'/>
                        </div>
                        ...
                        <div className='flex flex-col text-sm text-white mt-2'>
                            ...
                            outline-none text-secondary mt-1 rounded-3xl' type="text" placeholder='Bir Ürün Açıklaması Yazın...'/>
                        </div>
                        ...
                        <div className='flex flex-col text-sm text-white mt-2'>
                            ...
                            <div className='flex items-center justify-center gap-4'>
                                <input placeholder='İndirimli Fiyat' type="number" className='border w-full focus:border-secondary/50 p-2 outline-none text-secondary mt-1 rounded-full' 
...
{/*                     <div className='flex flex-col text-sm text-white mt-2'>
            ...
            <div className='flex mt-5 w-full'>
                <button onClick={handleCreate}  className='py-2 px-4 rounded-full disabled:opacity-50 duration-300 font-semibold !bg-dark hover:!bg-white hover:!text-dark w-full text-white'>Ürün Oluştur</button>
            </div>
